...
const AddNewBook: React.FC = () => {
    ...
    const handleAddNewBookTextarea = (event: ChangeEvent<HTMLTextAreaElement>) => {
        const {name, value} = event.target;
        setCreateNewBook((prev) => ({
            ...prev, [name]:value
        }))
        ...
        <div className='container'>
            ...
            <form onSubmit={handleAddNewBookSubmit} className='form addNewBook-wrap'>
                <div className='form__wrap addNewBook-wrap__top'>
                    ...
                    <input className='form__input' type="url" name="cover" onChange={handleAddNewBookForm} value={createNewBook.cover} />
                </div>
                <div className="addNewBook-wrap__center-left">
                <div className='form__wrap'>
                        <label  className='form__label' htmlFor="bookName">BOOK NAME</label>
                        <input className='form__input' type="text" name="title" onChange={handleAddNewBookForm} value={createNewBook.title}placeholder='Enter a book name' />
                </div>
                <div className='form__wrap'>
                    <label  className='form__label' htmlFor="author">AUTHOR</label>
                    <input className='form__input' type="text" name="author" onChange={handleAddNewBookForm} value={createNewBook.author} placeholder='Enter a book author' />
                </div>
                <div className='form__wrap'>
                    <label  className='form__label' htmlFor="genre">GENRE</label>
                    <select className='form__input' name="categoryId" onChange={handleAddNewBookSelect} value={createNewBook.categoryId} >
                ...
                <div className='form__wrap'>
                    ...
                    <input className='form__input' type="number" name="pages" onChange={handleAddNewBookForm} value={createNewBook.pages} placeholder='Enter number of pages' />
                </div>
                <div className='form__wrap'>
                    <label  className='form__label' htmlFor="year">YEAR OF PUBLICATION</label>
                    <input className='form__input' type="number" name="publisherDate" onChange={handleAddNewBookForm} value={createNewBook.publisherDate} placeholder='Enter year of publication' />
                </div>
                <div className='form__wrap'>
                    <label  className='form__label' htmlFor="language">LANGUAGE</label>
                    <input className='form__input' type="text" name="language" onChange={handleAddNewBookForm} value={createNewBook.language} placeholder='Enter a book language' />
                </div>
                <div className='form__wrap'>
                    <label  className='form__label' htmlFor="language">OWNER</label>
                    <input className='form__input' type="text" name="owner" onChange={handleAddNewBookForm} value={createNewBook.owner} placeholder='Enter a book language' />
                </div>
                ...
                <div className='form__wrap'>
                    ...
                    <textarea className='form__input' name="description" onChange={handleAddNewBookTextarea} value={createNewBook.description} placeholder='Write a description of a book' />
                </div>
                <div >
